...
<body>
                        ...
                        <div class="payment-body">
                            <div class="payment-plan">
                                ...
                                <div class="payment-plan-info">
                                    ...
                                    <div class="payment-plan-info-price">$750</div>
                                </div>
                            </div>
                            <div class="payment-summary">
                                ...
                                <div class="payment-summary-item payment-summary-total">
                                    ...
                                    <div class="payment-summary-price">$750</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function displayPaymentConfirmation(event) {
            ...
            doc.text(`Destination: Snowland`, 10, 20);
            doc.text(`Total Amount: $750`, 10, 30);

            // Save payment summary PDF
            doc.save('payment-summary-snow.pdf');
