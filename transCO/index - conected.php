...
<body id="top">
  <header class="header" data-header>
    ...
    <div class="header-top">
      <div class="container">
        <a href="tel:+212 612 34 56 90" class="helpline-box">
          <div class="icon-box">
            <ion-icon name="call-outline"></ion-icon>
          </div>
          <div class="wrapper">
            <p class="helpline-title">For Further Inquires :</p>
            <p class="helpline-number">+212 612 34 56 90</p>
          </div>
        </a>
        <a href="index - conected.php" class="logo">
          <img src="./assets/images/logo.png" style="height: 50px;" alt="TransCO logo">
        </a>
  ...
  <main>
    <article>
      ...
      <section class="tour-search">
        <div class="container">
            <form action="pay.php" method="GET" class="tour-search-form">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="number" name="people" id="people" required placeholder="No. of People" class="input-field" max="20">
                </div>
                <div class="input-wrapper">
      ...
      <section class="popular" id="destination">
        <div class="container">
          ...
          Check out our latest and best destinationss.
          </p>
            ...
            <li>
              <div class="popular-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">
                    <a href="#destination">Dubai</a>
                  </p>
                  <h3 class="h3 card-title">
                    <a href="#destination">Burj khalifa</a>
                  </h3>
                  <p class="card-text">
                    Fusce hic augue velit wisi ips quibusdam pariatur, iusto.
                  </p>
            ...
            <li>
              <div class="popular-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">
                    <a href="#destination">Japan</a>
                  </p>
                  <h3 class="h3 card-title">
                    <a href="#destination">Kyoto temple</a>
                  </h3>
                  <p class="card-text">
                    Fusce hic augue velit wisi ips quibusdam pariatur, iusto.
                  </p>
      ...
      <section class="package" id="package">
        <div class="container">
          ...
          <p class="section-text">
          Check out our latest and best offers.
          </p>
            ...
            <li>
              <div class="package-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">Enjoy a wonderful holiday in the snowy weather</h3>
                  ...
                  <ul class="card-meta-list">
                    ...
                    <li class="card-meta-item">
                      <div class="meta-box">
                        ...
                        <p class="text">Snowy mountains</p>
                      </div>
                    </li>
                ...
                <div class="card-price">
                  ...
                  <a href="pay - snow.php"><button class="btn btn-secondary">Book Now</button></a>
            ...
            <li>
              <div class="package-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">Summer Holiday To The London River</h3>
                ...
                <div class="card-price">
                  ...
                  <a href="pay - london.php"><button class="btn btn-secondary">Book Now</button></a>
            ...
            <li>
              <div class="package-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">Brightness of the weekend in Island of Hawaii</h3>
                ...
                <div class="card-price">
                  ...
                  <a href="pay - hawii.php"><button class="btn btn-secondary">Book Now</button></a>
      ...
      <section class="gallery" id="gallery">
        <div class="container">
          ...
          <p class="section-text">
          Share and publish your exciting adventures.
          </p>
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <div class="footer-contact">
          ...
          <ul>
            ...
            <li class="contact-item">
              <ion-icon name="mail-transCO"></ion-icon>

              <a href="mailto:info.transCO.com" class="contact-link">info.TransCO.com</a>
            </li>

            <li class="contact-item">
              <ion-icon name="TransCO local"></ion-icon>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2024 <a href="">trans CO</a>. All rights reserved
        </p>
        ...
        <ul class="footer-bottom-list">
          ...
          <li>
            <a href="termes - conected.php" class="footer-bottom-link">Term & Condition</a>
          </li>
